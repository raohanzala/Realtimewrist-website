...
function CategoryItem({categoryName, categoryImg}) {
  return (
    <Link>
      <div className="size-[88px] sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded-full overflow-hidden relative m-auto">
        ...
        <div className="absolute  text-center flex items-center bottom-4 left-[50%] top-[75%] -translate-x-[50%] -translate-y-[50%] text-white">
          <div>
            <h2 className='lg:text-sm text-xs text-gray-50 font-semibold uppercase'>{categoryName}</h2>
          </div>
        </div>
        </div>
      </div>
