...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='grid grid-cols-1 md:grid-cols-2 justify-between gap-4 pt-5 px-5 sm:pt-14 min-h-[80vh] border-t max-w-[1280px] mx-auto'>
      {/* --------- Left Side ----------- */}
